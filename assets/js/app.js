...
var topographic =L.tileLayer('https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png', {
  ...
  map = L.map('map', {
  center: [23.98641129407727, 46.02172851562501],
  zoom: 7,
...
var overLays = {
  "<img src='../assets/img/geochemical.png' width='28' height='28'>&nbsp; Geochemical Surveys in KSA": geochemical_feature_layer, 
  "<img src='../assets/img/minerals.png' width='28' height='28'>&nbsp; Mineral Occurrences in KSA": minrals_feature_layer, 
  "<img src='../assets/img/drillingwells.png' width='35' height='25'>&nbsp; Drilling And Wells in KSA": drilling_feature_layer,
  "<img src='../assets/img/geology.png' width='28' height='28'>&nbsp; Geological Data in KSA": geological_feature_layer,
...
//               // geochemical_legend_container
// fetch('https://ngdgis.sgs.gov.sa/ngdgis/rest/services/Geochemistry/Geochemistry_Samples/MapServer/legend?f=json')
...
//     document.getElementById('geochemical_legend_container').innerHTML = '<p>No layers available.</p>';
//     return;
//   }
...
//   document.getElementById('geochemical_legend_container').innerHTML = mineral_legendHTML;
// })
// .catch(err => {
//   console.error('Error fetching legend:', err);
//   document.getElementById('geochemical_legend_container').innerHTML = '<p>Error loading legend.</p>';
// });
...
//   // Check if the 'layers' and 'legend' properties exist
//   if (!data.layers || data.layers.length === 0) {
//     document.getElementById('mineral_legend_container').innerHTML = '<p>No layers available.</p>';
//     return;
//   }
...
//   document.getElementById('mineral_legend_container').innerHTML = mineral_legendHTML;
// })
// .catch(err => {
//   console.error('Error fetching legend:', err);
//   document.getElementById('mineral_legend_container').innerHTML = '<p>Error loading legend.</p>';
// });
...
//               // drilling_legend_container
// fetch('https://ngdgis.sgs.gov.sa/ngdgis/rest/services/Geosciences/Boreholes/MapServer/legend?f=json')
// .then(response => response.json())
// .then(data => {
//   // Log the entire data to see its structure
//   console.log(data);
...
//   // Check if the 'layers' and 'legend' properties exist
//   if (!data.layers || data.layers.length === 0) {
//     document.getElementById('drilling_legend_container').innerHTML = '<p>No layers available.</p>';
//     return;
//   }
...
//   document.getElementById('drilling_legend_container').innerHTML = mineral_legendHTML;
// })
// .catch(err => {
//   console.error('Error fetching legend:', err);
//   document.getElementById('drilling_legend_container').innerHTML = '<p>Error loading legend.</p>';
// });
...
//   // Check if the 'layers' and 'legend' properties exist
//   if (!data.layers || data.layers.length === 0) {
//     document.getElementById('geological_legend_container').innerHTML = '<p>No layers available.</p>';
//     return;
//   }
...
//   document.getElementById('geological_legend_container').innerHTML = mineral_legendHTML;
// })
// .catch(err => {
//   console.error('Error fetching legend:', err);
//   document.getElementById('geological_legend_container').innerHTML = '<p>Error loading legend.</p>';
// });
